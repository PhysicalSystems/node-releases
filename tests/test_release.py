...
@pytest.mark.parametrize("path", ["repos/PhysicalSystems/node/contents/secret", "repos/PhysicalSystems/node-releases/contents/main",
    "repos/PhysicalSystems/node-releases/releases/1/../../other", "https://attacker.invalid", "repos/PhysicalSystems/node-releases/releases/assets/0"])
...
def workflow(monkeypatch):
    ...
    run = {"id": 9, "run_attempt": 2, "event": "workflow_dispatch", "head_sha": "a" * 40, "head_branch": "main",
        "path": ".github/workflows/publish.yml", "repository": {"full_name": r.REPOSITORY, "private": False}}
